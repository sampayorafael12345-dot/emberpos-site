var $=Object.defineProperty;var J=(E,e,t)=>e in E?$(E,e,{enumerable:!0,configurable:!0,writable:!0,value:t}):E[e]=t;var A=(E,e,t)=>J(E,typeof e!="symbol"?e+"":e,t);import{S as Z}from"./expense-accounts-D6RZdT5F.js";import{i as ee}from"./sql-wasm-browser-mwzwnb94.js";class K extends Uint8Array{toString(e){if(e==="hex"||e===void 0){let t="";for(let T=0;T<this.length;T++)t+=this[T].toString(16).padStart(2,"0");return t}if(e==="utf8"||e==="utf-8")return new TextDecoder().decode(this);throw new Error("HexBytes.toString: unsupported encoding "+e)}}function Ee(E){const e=new K(E);return crypto.getRandomValues(e),e}function he(E,e){if(E.length!==e.length)throw new Error("Input buffers must have the same length");let t=0;for(let T=0;T<E.length;T++)t|=E[T]^e[T];return t===0}const te=new Uint32Array([1116352408,1899447441,3049323471,3921009573,961987163,1508970993,2453635748,2870763221,3624381080,310598401,607225278,1426881987,1925078388,2162078206,2614888103,3248222580,3835390401,4022224774,264347078,604807628,770255983,1249150122,1555081692,1996064986,2554220882,2821834349,2952996808,3210313671,3336571891,3584528711,113926993,338241895,666307205,773529912,1294757372,1396182291,1695183700,1986661051,2177026350,2456956037,2730485921,2820302411,3259730800,3345764771,3516065817,3600352804,4094571909,275423344,430227734,506948616,659060556,883997877,958139571,1322822218,1537002063,1747873779,1955562222,2024104815,2227730452,2361852424,2428436474,2756734187,3204031479,3329325298]);class F{constructor(){A(this,"h",new Uint32Array([1779033703,3144134277,1013904242,2773480762,1359893119,2600822924,528734635,1541459225]));A(this,"block",new Uint8Array(64));A(this,"w",new Uint32Array(64));A(this,"fill",0);A(this,"len",0)}update(e){this.len+=e.length;let t=0;for(;t<e.length;){const T=Math.min(64-this.fill,e.length-t);this.block.set(e.subarray(t,t+T),this.fill),this.fill+=T,t+=T,this.fill===64&&(this.compress(),this.fill=0)}return this}compress(){const{block:e,w:t,h:T}=this;for(let n=0;n<16;n++)t[n]=e[n*4]<<24|e[n*4+1]<<16|e[n*4+2]<<8|e[n*4+3];for(let n=16;n<64;n++){const _=t[n-15],a=t[n-2],u=(_>>>7|_<<25)^(_>>>18|_<<14)^_>>>3,U=(a>>>17|a<<15)^(a>>>19|a<<13)^a>>>10;t[n]=t[n-16]+u+t[n-7]+U|0}let s=T[0],r=T[1],N=T[2],I=T[3],L=T[4],i=T[5],c=T[6],R=T[7];for(let n=0;n<64;n++){const _=(L>>>6|L<<26)^(L>>>11|L<<21)^(L>>>25|L<<7),a=L&i^~L&c,u=R+_+a+te[n]+t[n]|0,U=(s>>>2|s<<30)^(s>>>13|s<<19)^(s>>>22|s<<10),m=s&r^s&N^r&N,h=U+m|0;R=c,c=i,i=L,L=I+u|0,I=N,N=r,r=s,s=u+h|0}T[0]=T[0]+s|0,T[1]=T[1]+r|0,T[2]=T[2]+N|0,T[3]=T[3]+I|0,T[4]=T[4]+L|0,T[5]=T[5]+i|0,T[6]=T[6]+c|0,T[7]=T[7]+R|0}digest(){const e=this.len*8;for(this.update(new Uint8Array([128]));this.fill!==56;)this.update(new Uint8Array([0]));const t=new Uint8Array(8);t[0]=e/4294967296>>>24,t[1]=e/4294967296>>>16,t[2]=e/4294967296>>>8,t[3]=e/4294967296&255,t[4]=e>>>24&255,t[5]=e>>>16&255,t[6]=e>>>8&255,t[7]=e&255,this.update(t);const T=new Uint8Array(32);for(let s=0;s<8;s++)T[s*4]=this.h[s]>>>24,T[s*4+1]=this.h[s]>>>16&255,T[s*4+2]=this.h[s]>>>8&255,T[s*4+3]=this.h[s]&255;return T}}const Te=E=>new F().update(E).digest();function x(E,e){let t=E.length>64?Te(E):E;const T=new Uint8Array(64).fill(54),s=new Uint8Array(64).fill(92);for(let N=0;N<t.length;N++)T[N]^=t[N],s[N]^=t[N];const r=new F().update(T).update(e).digest();return new F().update(s).update(r).digest()}function se(E,e,t,T,s){if(s!=="sha256")throw new Error("pbkdf2Sync shim: only sha256");const r=typeof E=="string"?new TextEncoder().encode(E):E,N=typeof e=="string"?new TextEncoder().encode(e):e,I=new K(T),L=Math.ceil(T/32);for(let i=1;i<=L;i++){const c=new Uint8Array(N.length+4);c.set(N),c[N.length]=i>>>24,c[N.length+1]=i>>>16&255,c[N.length+2]=i>>>8&255,c[N.length+3]=i&255;let R=x(r,c);const n=new Uint8Array(R);for(let _=1;_<t;_++){R=x(r,R);for(let a=0;a<32;a++)n[a]^=R[a]}I.set(n.subarray(0,Math.min(32,T-(i-1)*32)),(i-1)*32)}return I}const re="/demo/assets/sql-wasm-UFUCzYNW.wasm",ne="emberpos-demo",p="db",B="bytes";function q(){return new Promise((E,e)=>{const t=indexedDB.open(ne,1);t.onupgradeneeded=()=>t.result.createObjectStore(p),t.onsuccess=()=>E(t.result),t.onerror=()=>e(t.error)})}async function ie(){try{const E=await q();return await new Promise(e=>{const T=E.transaction(p,"readonly").objectStore(p).get(B);T.onsuccess=()=>e(T.result instanceof Uint8Array?T.result:null),T.onerror=()=>e(null)})}catch{return null}}async function oe(E){try{const e=await q();await new Promise(t=>{const T=e.transaction(p,"readwrite");T.objectStore(p).put(E,B),T.oncomplete=()=>t(),T.onerror=()=>t()})}catch{}}function Ne(){return"browser:indexeddb/emberpos-demo"}async function ae(){return ee({locateFile:()=>re})}async function ce(E){const e=await ie();if(e&&e.length>0)return e;const t=T=>{const s="SQLite format 3";for(let r=0;r<s.length;r++)if(T[r]!==s.charCodeAt(r))return null;return T};if(typeof DecompressionStream=="function")try{const T=await fetch("demo-shop.db.gz",{cache:"no-store"});if(T.ok&&T.body){const s=T.body.pipeThrough(new DecompressionStream("gzip")),r=t(new Uint8Array(await new Response(s).arrayBuffer()));if(r)return r}}catch{}try{const T=await fetch("demo-shop.db",{cache:"no-store"});return T.ok?t(new Uint8Array(await T.arrayBuffer())):null}catch{return null}}let Y=Promise.resolve();function de(E,e){const t=new Uint8Array(e);Y=Y.then(()=>oe(t))}let l=null,g="",y=null;function O(){if(!l)throw new Error("Database not initialized. Call initDatabase() first.");return l}function Le(){return g}async function Re(){g=Ne();const E=await ae(),e=await ce();return l=e?new E.Database(e):new E.Database,l.exec(`
  ...
  `),_e(l),Ie(l),S(),l}function _e(E){var N,I,L;const e=(i,c,R)=>{var a;(((a=E.exec(`PRAGMA table_info(${i})`)[0])==null?void 0:a.values.map(u=>u[1]))??[]).includes(c)||E.exec(`ALTER TABLE ${i} ADD COLUMN ${c} ${R}`)};e("orders","discount_cents","INTEGER NOT NULL DEFAULT 0"),e("orders","discount_reason","TEXT"),e("orders","voided_at","TEXT"),e("orders","voided_by","INTEGER"),e("orders","void_reason","TEXT"),e("menu_items","cost_cents","INTEGER"),e("menu_items","sold_by","TEXT NOT NULL DEFAULT 'each'"),e("menu_items","track_stock","INTEGER NOT NULL DEFAULT 0"),e("menu_items","is_composite","INTEGER NOT NULL DEFAULT 0"),e("menu_items","color","TEXT"),e("menu_items","shape","TEXT"),e("orders","shift_id","INTEGER"),e("order_items","variant_id","INTEGER"),e("order_items","variant_label","TEXT"),e("orders","cash_tendered_cents","INTEGER"),e("orders","change_cents","INTEGER"),e("orders","customer_id","INTEGER"),e("orders","refunded_cents","INTEGER NOT NULL DEFAULT 0"),e("users","wage_cents_per_hour","INTEGER NOT NULL DEFAULT 0"),e("orders","tip_cents","INTEGER NOT NULL DEFAULT 0"),e("menu_items","barcode","TEXT"),e("orders","or_number","INTEGER"),e("timecards","break_minutes","INTEGER NOT NULL DEFAULT 0"),e("customers","birthday","TEXT"),e("customers","no_message","INTEGER NOT NULL DEFAULT 0"),e("customers","last_messaged_at","TEXT"),e("ingredients","brand","TEXT"),e("ingredients","supplier","TEXT"),e("ingredients","pack_size","TEXT"),e("menu_items","tax_exempt","INTEGER NOT NULL DEFAULT 0"),e("menu_items","zero_rated","INTEGER NOT NULL DEFAULT 0"),e("menu_items","addon_max_picks","INTEGER"),e("menu_variants","addon_max_picks","INTEGER"),e("menu_items","no_addons","INTEGER NOT NULL DEFAULT 0"),e("order_items","modifier_ids","TEXT"),e("stock_movements","user_id","INTEGER"),e("expenses","category_name_snapshot","TEXT"),e("expenses","category_kind_snapshot","TEXT"),e("expenses","reviewed_at","TEXT"),e("expenses","reviewed_by","INTEGER"),e("menu_items","addon_min_picks","INTEGER"),e("menu_variants","addon_min_picks","INTEGER"),e("cash_custody","received_at","TEXT"),e("cash_custody","received_by","INTEGER"),e("cash_custody","verified_at","TEXT"),e("cash_custody","verified_by","INTEGER"),e("expenses","voided_at","TEXT"),e("expenses","voided_by","INTEGER"),e("expenses","void_reason","TEXT"),e("orders","ready_at","TEXT"),e("shifts","paused_at","TEXT"),e("shifts","covers_shift_id","INTEGER"),e("orders","business_date","TEXT"),e("orders","business_day_id","INTEGER"),e("purchase_orders","received_by","INTEGER"),e("purchase_orders","payment_terms","TEXT"),e("purchase_orders","paid_at","TEXT"),e("purchase_orders","paid_via","TEXT"),e("expense_categories","kind","TEXT NOT NULL DEFAULT 'operating'"),e("expense_categories","spread_basis","TEXT NOT NULL DEFAULT 'calendar'"),e("users","must_change_pin","INTEGER NOT NULL DEFAULT 0"),e("users","def_allowance_cents","INTEGER NOT NULL DEFAULT 0"),e("users","def_sss_cents","INTEGER NOT NULL DEFAULT 0"),e("users","def_philhealth_cents","INTEGER NOT NULL DEFAULT 0"),e("users","def_pagibig_cents","INTEGER NOT NULL DEFAULT 0"),e("users","def_tax_cents","INTEGER NOT NULL DEFAULT 0"),e("users","def_other_cents","INTEGER NOT NULL DEFAULT 0"),e("modifiers_library","price_cents","INTEGER NOT NULL DEFAULT 0"),e("modifiers_library","cost_cents","INTEGER"),e("categories","station","TEXT"),e("payroll_lines","tip_cents","INTEGER NOT NULL DEFAULT 0"),e("recipes","entry_qty","REAL"),e("recipes","entry_unit","TEXT"),e("ingredients","pack_label","TEXT"),e("ingredients","pack_qty","REAL"),e("ingredients","image_path","TEXT"),e("ingredients","barcode","TEXT"),e("ingredients","made_in_house","INTEGER DEFAULT 0"),e("ingredients","prep_batch_qty","REAL"),e("ingredients","kind","TEXT NOT NULL DEFAULT 'food'"),e("orders","collected_at","TEXT"),e("orders","pickup_label","TEXT"),e("inventory_counts","audited_at","TEXT"),e("inventory_counts","audited_by","TEXT"),e("inventory_counts","snapshot_deferred","INTEGER NOT NULL DEFAULT 0"),e("order_payments","ref","TEXT"),e("cash_movements","source","TEXT"),e("cash_movements","ref_id","INTEGER");try{E.exec("UPDATE ingredients SET unit = 'piece' WHERE unit IN ('each','pc')"),E.exec("UPDATE recipes SET entry_unit = 'piece' WHERE entry_unit IN ('each','pc')")}catch{}try{const i=E.exec("SELECT id, unit FROM ingredients WHERE unit IN ('g','mL')"),c=i.length?i[0].values:[];for(const R of c){const n=R[0],_=R[1],a=_==="g"?"kg":"L";E.run(`UPDATE ingredients SET unit = ?,
    ...
    `)}catch{}((I=(N=E.exec("SELECT value FROM settings WHERE key = 'currency_symbol'")[0])==null?void 0:N.values[0])==null?void 0:I[0])==="$"&&E.exec("UPDATE settings SET value = '₱' WHERE key = 'currency_symbol'");const r=(((L=E.exec("SELECT id FROM users WHERE password_hash IS NULL OR password_hash = ''")[0])==null?void 0:L.values)??[]).map(i=>i[0]);if(r.length>0){const i=H("1234"),c=E.prepare("UPDATE users SET password_hash = ? WHERE id = ?");for(const R of r)c.run([i,R]);c.free()}E.exec(`
  ...
  `)}function H(E){const e=Ee(16).toString("hex"),t=se(E,e,1e5,32,"sha256").toString("hex");return`${e}:${t}`}function Ie(E){var a,u,U,m,h,f,G,D,w,b,M,v,k,P;const e=E.prepare("INSERT OR IGNORE INTO settings (key, value) VALUES (?, ?)"),t=[["restaurant_name","My Restaurant"],["tax_percent","0"],["currency_symbol","₱"],["receipt_footer","Thank you — come again!"],["order_seq","0"],["biz_address",""],["biz_tin",""],["biz_vat_status","non-vat"],["biz_min",""],["biz_serial_no",""],["biz_accred_no",""],["biz_permit_no",""],["biz_receipt_prefix","OR-"],["or_seq","0"],["loyalty_stamps_required","10"],["idle_logout_minutes","0"],["daily_sales_goal_cents","0"],["kds_sound","1"],["kitchen_printer_name",""],["kitchen_auto_print","0"],["happy_hour_enabled","0"],["happy_hour_percent","10"],["happy_hour_start","14:00"],["happy_hour_end","17:00"],["drawer_network",""],["drawer_auto_kick","1"],["ui_zoom","1"],["receipt_logo",""],["setup_done","0"],["theme","dark"],["quote_seq","0"],["payroll_ot_threshold_hours","8"],["payroll_ot_multiplier","1.25"]];for(const[d,o]of t)e.run([d,o]);if(e.free(),((u=(a=E.exec("SELECT COUNT(*) as c FROM users")[0])==null?void 0:a.values[0])==null?void 0:u[0])===0){const d=H("1234"),o=E.prepare("INSERT INTO users (username, password_hash, full_name, role, pin, active) VALUES (?, ?, ?, ?, ?, 1)");o.run(["admin",d,"Owner","owner",null]),o.free()}const r=E.prepare("INSERT OR IGNORE INTO payment_types (name, code, sort_order, color, active) VALUES (?, ?, ?, ?, 1)");if(r.run(["Cash","cash",1,"#16a34a"]),r.run(["Card","card",2,"#2563eb"]),r.run(["GCash","gcash",3,"#0ea5e9"]),r.run(["Gift Card","giftcard",4,"#a855f7"]),r.free(),((m=(U=E.exec("SELECT COUNT(*) as c FROM predefined_tickets")[0])==null?void 0:U.values[0])==null?void 0:m[0])===0){const d=E.prepare("INSERT INTO predefined_tickets (label, kind, sort_order, active) VALUES (?, ?, ?, 1)");for(let o=1;o<=5;o++)d.run([`Table ${o}`,"table",o]);d.run(["Takeout","takeout",10]),d.free()}if(((f=(h=E.exec("SELECT COUNT(*) as c FROM dining_tables")[0])==null?void 0:h.values[0])==null?void 0:f[0])===0){const d=E.prepare("INSERT INTO dining_tables (label, seats, sort_order, active) VALUES (?, ?, ?, 1)");for(let o=1;o<=8;o++)d.run([String(o),o<=4?2:4,o]);d.free()}if(((D=(G=E.exec("SELECT COUNT(*) as c FROM expense_categories")[0])==null?void 0:G.values[0])==null?void 0:D[0])===0){const d=E.prepare("INSERT INTO expense_categories (name, kind, active, spread_basis) VALUES (?, ?, 1, ?)");for(const o of Z)d.run([o.name,o.kind,o.basis]);d.free()}if((b=(w=E.exec("SELECT value FROM settings WHERE key = 'fix_payroll_spread_done'")[0])==null?void 0:w.values)!=null&&b.length||(E.run(`UPDATE expense_categories SET spread_basis = 'open'
       WHERE spread_basis = 'calendar'
         AND lower(trim(name)) IN ('salaries & wages', 'salaries and wages', 'wages', 'payroll')`),E.run("INSERT OR REPLACE INTO settings (key, value) VALUES ('fix_payroll_spread_done', '1')")),((v=(M=E.exec("SELECT COUNT(*) as c FROM locations")[0])==null?void 0:M.values[0])==null?void 0:v[0])===0){const d=E.prepare("INSERT INTO locations (name, sort_order, active) VALUES (?, ?, 1)");["Main Store","Kitchen","Bar Station","Cold Storage"].forEach((o,C)=>d.run([o,C+1])),d.free()}if(V(E),((P=(k=E.exec("SELECT COUNT(*) as c FROM modifiers_library")[0])==null?void 0:k.values[0])==null?void 0:P[0])===0){const d=[["Extra rice","addons",1],["Extra egg","addons",2],["Extra sauce","addons",3],["Extra ice","temp",4],["No ice","temp",5],["Hot","temp",6],["Iced","temp",7],["No sugar","sugar",8],["Less sugar (50%)","sugar",9],["Sugar 25%","sugar",10],["Extra sweet","sugar",11],["No onions","omit",12],["No garlic","omit",13],["No spicy","spice",14],["Extra spicy","spice",15],["To go","service",16],["For pick-up","service",17],["Rush order","service",18]],o=E.prepare("INSERT INTO modifiers_library (text, category, sort_order, active) VALUES (?, ?, ?, 1)");for(const C of d)o.run(C);o.free()}}const W=[{capability:"pos.use",roles:["owner","manager","cashier"]},{capability:"kitchen.use",roles:["owner","manager","cashier","kitchen"]},{capability:"menu.read",roles:["owner","manager","cashier","kitchen"]},{capability:"menu.write",roles:["owner","manager"]},{capability:"inventory.read",roles:["owner","manager"]},{capability:"inventory.write",roles:["owner","manager"]},{capability:"inventory.adjust",roles:["owner","manager"]},{capability:"inventory.count",roles:["owner","manager"]},{capability:"reports.view",roles:["owner","manager","accountant"]},{capability:"admin.view",roles:["owner","manager"]},{capability:"admin.access",roles:["owner"]},{capability:"settings.read",roles:["owner","manager","cashier","kitchen","accountant"]},{capability:"settings.write",roles:["owner","manager"]},{capability:"users.manage",roles:["owner","manager"]},{capability:"orders.discount",roles:["owner","manager"]},{capability:"orders.void_paid",roles:["owner","manager"]},{capability:"csv.use",roles:["owner","manager","accountant"]},{capability:"backup.use",roles:["owner"]},{capability:"timeclock.use",roles:["owner","manager","cashier","kitchen"]},{capability:"timecards.view",roles:["owner","manager"]},{capability:"orders.refund",roles:["owner","manager"]},{capability:"shifts.manage",roles:["owner","manager","cashier"]},{capability:"shifts.cash",roles:["owner","manager"]},{capability:"payroll.run",roles:["owner","manager"]},{capability:"inventory.transfer",roles:["owner","manager"]},{capability:"branches.switch",roles:["owner","manager"]},{capability:"inventory.template_manage",roles:["owner","manager"]},{capability:"inventory.count_adjust",roles:["owner","manager"]},{capability:"shifts.see_expected",roles:["owner","manager"]},{capability:"inventory.receive",roles:["owner","manager","cashier","kitchen"]},{capability:"menu.availability",roles:["owner","manager","cashier","kitchen"]},{capability:"inventory.count_start",roles:["owner","manager"]}],z=["owner","manager","cashier","kitchen","accountant"];function V(E){const e=E.prepare("INSERT OR IGNORE INTO role_permissions (role, capability, allowed) VALUES (?, ?, ?)");for(const{capability:t,roles:T}of W)for(const s of z)e.run([s,t,T.includes(s)?1:0]);e.free()}function Q(E,e){const t=e.findIndex(T=>T===void 0);if(t!==-1)throw new Error(`SQL bind #${t+1} is undefined in: ${E.replace(/\s+/g," ").slice(0,160)}`)}function j(E,e=[]){Q(E,e);const t=O().prepare(E);e.length&&t.bind(e);const T=[];for(;t.step();)T.push(t.getAsObject());return t.free(),T}function ue(E,e=[]){return j(E,e)[0]??null}function le(E,e=[]){var r;Q(E,e);const t=O();t.run(E,e);const s=((r=t.exec("SELECT last_insert_rowid() as id, changes() as ch")[0])==null?void 0:r.values[0])??[0,0];return X(),{lastInsertRowid:s[0],changes:s[1]}}function Ue(E){O().exec(E),X()}function Ae(E){const e=O();e.exec("BEGIN");try{const t=E();return e.exec("COMMIT"),S(),t}catch(t){throw e.exec("ROLLBACK"),t}}function S(){l&&de(g,l.export())}function X(E=500){y&&clearTimeout(y),y=setTimeout(S,E)}const Se=Object.freeze(Object.defineProperty({__proto__:null,ALL_ROLES:z,CAPABILITY_DEFAULTS:W,all:j,exec:Ue,getDb:O,getDbFilePath:Le,initDatabase:Re,one:ue,run:le,saveDebounced:X,saveNow:S,seedDefaultPermissions:V,transaction:Ae},Symbol.toStringTag,{value:"Module"}));export{j as a,le as b,Ae as c,Se as d,Le as g,ue as o,se as p,Ee as r,S as s,he as t};
