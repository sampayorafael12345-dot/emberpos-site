var te=Object.defineProperty;var Te=(E,e,T)=>e in E?te(E,e,{enumerable:!0,configurable:!0,writable:!0,value:T}):E[e]=T;var A=(E,e,T)=>Te(E,typeof e!="symbol"?e+"":e,T);import{S as se,P as B}from"./expense-accounts-CFJ596_h.js";import{i as re}from"./sql-wasm-browser-mwzwnb94.js";class W extends Uint8Array{toString(e){if(e==="hex"||e===void 0){let T="";for(let t=0;t<this.length;t++)T+=this[t].toString(16).padStart(2,"0");return T}if(e==="utf8"||e==="utf-8")return new TextDecoder().decode(this);throw new Error("HexBytes.toString: unsupported encoding "+e)}}function ne(E){const e=new W(E);return crypto.getRandomValues(e),e}function Fe(E,e){if(E.length!==e.length)throw new Error("Input buffers must have the same length");let T=0;for(let t=0;t<E.length;t++)T|=E[t]^e[t];return T===0}const ie=new Uint32Array([1116352408,1899447441,3049323471,3921009573,961987163,1508970993,2453635748,2870763221,3624381080,310598401,607225278,1426881987,1925078388,2162078206,2614888103,3248222580,3835390401,4022224774,264347078,604807628,770255983,1249150122,1555081692,1996064986,2554220882,2821834349,2952996808,3210313671,3336571891,3584528711,113926993,338241895,666307205,773529912,1294757372,1396182291,1695183700,1986661051,2177026350,2456956037,2730485921,2820302411,3259730800,3345764771,3516065817,3600352804,4094571909,275423344,430227734,506948616,659060556,883997877,958139571,1322822218,1537002063,1747873779,1955562222,2024104815,2227730452,2361852424,2428436474,2756734187,3204031479,3329325298]);class S{constructor(){A(this,"h",new Uint32Array([1779033703,3144134277,1013904242,2773480762,1359893119,2600822924,528734635,1541459225]));A(this,"block",new Uint8Array(64));A(this,"w",new Uint32Array(64));A(this,"fill",0);A(this,"len",0)}update(e){this.len+=e.length;let T=0;for(;T<e.length;){const t=Math.min(64-this.fill,e.length-T);this.block.set(e.subarray(T,T+t),this.fill),this.fill+=t,T+=t,this.fill===64&&(this.compress(),this.fill=0)}return this}compress(){const{block:e,w:T,h:t}=this;for(let i=0;i<16;i++)T[i]=e[i*4]<<24|e[i*4+1]<<16|e[i*4+2]<<8|e[i*4+3];for(let i=16;i<64;i++){const _=T[i-15],L=T[i-2],u=(_>>>7|_<<25)^(_>>>18|_<<14)^_>>>3,U=(L>>>17|L<<15)^(L>>>19|L<<13)^L>>>10;T[i]=T[i-16]+u+T[i-7]+U|0}let s=t[0],r=t[1],o=t[2],I=t[3],a=t[4],n=t[5],d=t[6],R=t[7];for(let i=0;i<64;i++){const _=(a>>>6|a<<26)^(a>>>11|a<<21)^(a>>>25|a<<7),L=a&n^~a&d,u=R+_+L+ie[i]+T[i]|0,U=(s>>>2|s<<30)^(s>>>13|s<<19)^(s>>>22|s<<10),h=s&r^s&o^r&o,m=U+h|0;R=d,d=n,n=a,a=I+u|0,I=o,o=r,r=s,s=u+m|0}t[0]=t[0]+s|0,t[1]=t[1]+r|0,t[2]=t[2]+o|0,t[3]=t[3]+I|0,t[4]=t[4]+a|0,t[5]=t[5]+n|0,t[6]=t[6]+d|0,t[7]=t[7]+R|0}digest(){const e=this.len*8;for(this.update(new Uint8Array([128]));this.fill!==56;)this.update(new Uint8Array([0]));const T=new Uint8Array(8);T[0]=e/4294967296>>>24,T[1]=e/4294967296>>>16,T[2]=e/4294967296>>>8,T[3]=e/4294967296&255,T[4]=e>>>24&255,T[5]=e>>>16&255,T[6]=e>>>8&255,T[7]=e&255,this.update(T);const t=new Uint8Array(32);for(let s=0;s<8;s++)t[s*4]=this.h[s]>>>24,t[s*4+1]=this.h[s]>>>16&255,t[s*4+2]=this.h[s]>>>8&255,t[s*4+3]=this.h[s]&255;return t}}const Ne=E=>new S().update(E).digest();function q(E,e){let T=E.length>64?Ne(E):E;const t=new Uint8Array(64).fill(54),s=new Uint8Array(64).fill(92);for(let o=0;o<T.length;o++)t[o]^=T[o],s[o]^=T[o];const r=new S().update(t).update(e).digest();return new S().update(s).update(r).digest()}function oe(E,e,T,t,s){if(s!=="sha256")throw new Error("pbkdf2Sync shim: only sha256");const r=typeof E=="string"?new TextEncoder().encode(E):E,o=typeof e=="string"?new TextEncoder().encode(e):e,I=new W(t),a=Math.ceil(t/32);for(let n=1;n<=a;n++){const d=new Uint8Array(o.length+4);d.set(o),d[o.length]=n>>>24,d[o.length+1]=n>>>16&255,d[o.length+2]=n>>>8&255,d[o.length+3]=n&255;let R=q(r,d);const i=new Uint8Array(R);for(let _=1;_<T;_++){R=q(r,R);for(let L=0;L<32;L++)i[L]^=R[L]}I.set(i.subarray(0,Math.min(32,t-(n-1)*32)),(n-1)*32)}return I}function Xe(E){if(E!=="sha256")throw new Error("createHash shim: only sha256");const e=new S,T={update(t){return e.update(typeof t=="string"?new TextEncoder().encode(t):t),T},digest(t){const s=e.digest();if(t==="hex")return Array.from(s).map(r=>r.toString(16).padStart(2,"0")).join("");if(t)throw new Error("createHash shim: only hex");return s}};return T}const ae="/demo/assets/sql-wasm-UFUCzYNW.wasm",de="emberpos-demo",O="db",z="bytes";function Q(){return new Promise((E,e)=>{const T=indexedDB.open(de,1);T.onupgradeneeded=()=>T.result.createObjectStore(O),T.onsuccess=()=>E(T.result),T.onerror=()=>e(T.error)})}async function ce(){try{const E=await Q();return await new Promise(e=>{const t=E.transaction(O,"readonly").objectStore(O).get(z);t.onsuccess=()=>e(t.result instanceof Uint8Array?t.result:null),t.onerror=()=>e(null)})}catch{return null}}async function Le(E){try{const e=await Q();await new Promise(T=>{const t=e.transaction(O,"readwrite");t.objectStore(O).put(E,z),t.oncomplete=()=>T(),t.onerror=()=>T()})}catch{}}function Re(){return"browser:indexeddb/emberpos-demo"}async function _e(){return re({locateFile:()=>ae})}async function Ie(E){const e=await ce();if(e&&e.length>0)return e;const T=t=>{const s="SQLite format 3";for(let r=0;r<s.length;r++)if(t[r]!==s.charCodeAt(r))return null;return t};if(typeof DecompressionStream=="function")try{const t=await fetch("demo-shop.db.gz",{cache:"no-store"});if(t.ok&&t.body){const s=t.body.pipeThrough(new DecompressionStream("gzip")),r=T(new Uint8Array(await new Response(s).arrayBuffer()));if(r)return r}}catch{}try{const t=await fetch("demo-shop.db",{cache:"no-store"});return t.ok?T(new Uint8Array(await t.arrayBuffer())):null}catch{return null}}let H=Promise.resolve();function ue(E,e){const T=new Uint8Array(e);H=H.then(()=>Le(T))}let l=null,F="",g=null;function p(){if(!l)throw new Error("Database not initialized. Call initDatabase() first.");return l}function le(){return F}async function Ue(){F=Re();const E=await _e(),e=await Ie();return l=e?new E.Database(e):new E.Database,l.exec(`
  ...
  `),Ae(l),Oe(l),C(),l}function Ae(E){var o,I,a;const e=(n,d,R)=>{var L;(((L=E.exec(`PRAGMA table_info(${n})`)[0])==null?void 0:L.values.map(u=>u[1]))??[]).includes(d)||E.exec(`ALTER TABLE ${n} ADD COLUMN ${d} ${R}`)};e("orders","discount_cents","INTEGER NOT NULL DEFAULT 0"),e("orders","discount_reason","TEXT"),e("orders","voided_at","TEXT"),e("orders","voided_by","INTEGER"),e("orders","void_reason","TEXT"),e("orders","source","TEXT"),e("menu_items","cost_cents","INTEGER"),e("menu_items","sold_by","TEXT NOT NULL DEFAULT 'each'"),e("menu_items","track_stock","INTEGER NOT NULL DEFAULT 0"),e("menu_items","is_composite","INTEGER NOT NULL DEFAULT 0"),e("menu_items","color","TEXT"),e("menu_items","shape","TEXT"),e("orders","shift_id","INTEGER"),e("order_items","variant_id","INTEGER"),e("order_items","variant_label","TEXT"),e("orders","cash_tendered_cents","INTEGER"),e("orders","change_cents","INTEGER"),e("orders","customer_id","INTEGER"),e("orders","refunded_cents","INTEGER NOT NULL DEFAULT 0"),e("users","wage_cents_per_hour","INTEGER NOT NULL DEFAULT 0"),e("orders","tip_cents","INTEGER NOT NULL DEFAULT 0"),e("menu_items","barcode","TEXT"),e("orders","or_number","INTEGER"),e("timecards","break_minutes","INTEGER NOT NULL DEFAULT 0"),e("customers","birthday","TEXT"),e("customers","no_message","INTEGER NOT NULL DEFAULT 0"),e("customers","last_messaged_at","TEXT"),e("ingredients","brand","TEXT"),e("ingredients","supplier","TEXT"),e("ingredients","pack_size","TEXT"),e("menu_items","tax_exempt","INTEGER NOT NULL DEFAULT 0"),e("menu_items","zero_rated","INTEGER NOT NULL DEFAULT 0"),e("menu_items","addon_max_picks","INTEGER"),e("menu_variants","addon_max_picks","INTEGER"),e("menu_items","no_addons","INTEGER NOT NULL DEFAULT 0"),e("order_items","modifier_ids","TEXT"),e("stock_movements","user_id","INTEGER"),e("expenses","category_name_snapshot","TEXT"),e("expenses","category_kind_snapshot","TEXT"),e("expenses","reviewed_at","TEXT"),e("expenses","reviewed_by","INTEGER"),e("menu_items","addon_min_picks","INTEGER"),e("menu_variants","addon_min_picks","INTEGER"),e("cash_custody","received_at","TEXT"),e("cash_custody","received_by","INTEGER"),e("cash_custody","verified_at","TEXT"),e("cash_custody","verified_by","INTEGER"),e("expenses","voided_at","TEXT"),e("expenses","voided_by","INTEGER"),e("expenses","void_reason","TEXT"),e("orders","ready_at","TEXT"),e("shifts","paused_at","TEXT"),e("shifts","covers_shift_id","INTEGER"),e("orders","business_date","TEXT"),e("orders","business_day_id","INTEGER"),e("purchase_orders","received_by","INTEGER"),e("purchase_orders","payment_terms","TEXT"),e("purchase_orders","paid_at","TEXT"),e("purchase_orders","paid_via","TEXT"),e("expense_categories","kind","TEXT NOT NULL DEFAULT 'operating'"),e("expense_categories","spread_basis","TEXT NOT NULL DEFAULT 'calendar'"),e("expense_categories","is_payroll","INTEGER NOT NULL DEFAULT 0"),e("users","must_change_pin","INTEGER NOT NULL DEFAULT 0"),e("users","def_allowance_cents","INTEGER NOT NULL DEFAULT 0"),e("users","def_sss_cents","INTEGER NOT NULL DEFAULT 0"),e("users","def_philhealth_cents","INTEGER NOT NULL DEFAULT 0"),e("users","def_pagibig_cents","INTEGER NOT NULL DEFAULT 0"),e("users","def_tax_cents","INTEGER NOT NULL DEFAULT 0"),e("users","def_other_cents","INTEGER NOT NULL DEFAULT 0"),e("modifiers_library","price_cents","INTEGER NOT NULL DEFAULT 0"),e("modifiers_library","cost_cents","INTEGER"),e("categories","station","TEXT"),e("payroll_lines","tip_cents","INTEGER NOT NULL DEFAULT 0"),e("recipes","entry_qty","REAL"),e("recipes","entry_unit","TEXT"),e("ingredients","pack_label","TEXT"),e("ingredients","pack_qty","REAL"),e("ingredients","image_path","TEXT"),e("ingredients","barcode","TEXT"),e("ingredients","made_in_house","INTEGER DEFAULT 0"),e("ingredients","prep_batch_qty","REAL"),e("ingredients","kind","TEXT NOT NULL DEFAULT 'food'"),e("orders","collected_at","TEXT"),e("orders","pickup_label","TEXT"),e("inventory_counts","audited_at","TEXT"),e("inventory_counts","audited_by","TEXT"),e("inventory_counts","snapshot_deferred","INTEGER NOT NULL DEFAULT 0"),e("order_payments","ref","TEXT"),e("cash_movements","source","TEXT"),e("cash_movements","ref_id","INTEGER");try{E.exec("UPDATE ingredients SET unit = 'piece' WHERE unit IN ('each','pc')"),E.exec("UPDATE recipes SET entry_unit = 'piece' WHERE entry_unit IN ('each','pc')")}catch{}try{const n=E.exec("SELECT id, unit FROM ingredients WHERE unit IN ('g','mL')"),d=n.length?n[0].values:[];for(const R of d){const i=R[0],_=R[1],L=_==="g"?"kg":"L";E.run(`UPDATE ingredients SET unit = ?,
         ...
         WHERE id = ?`,[L,i]),E.run("UPDATE recipes SET qty = qty / 1000.0 WHERE ingredient_id = ?",[i]),E.run("UPDATE recipes SET entry_qty = entry_qty / 1000.0, entry_unit = ? WHERE ingredient_id = ? AND entry_unit = ?",[L,i,_])}}catch{}e("menu_items","extra_cost_cents","INTEGER NOT NULL DEFAULT 0"),e("menu_items","retired_at","TEXT"),e("ingredients","retired_at","TEXT"),e("purchase_order_items","received_packs","REAL"),e("shifts","left_in_drawer_cents","INTEGER"),e("cash_custody","split_from","INTEGER"),e("orders","service_charge_cents","INTEGER NOT NULL DEFAULT 0"),e("orders","deposit_cents","INTEGER NOT NULL DEFAULT 0"),e("orders","service_charge_waived","INTEGER NOT NULL DEFAULT 0"),e("orders","pickup_at","TEXT"),e("orders","promised_at","TEXT"),e("order_items","course","INTEGER NOT NULL DEFAULT 1"),e("order_items","fired_at","TEXT"),e("menu_items","allergens","TEXT"),e("menu_items","diet_tags","TEXT"),e("menu_items","kcal","INTEGER"),e("menu_items","protein_g","REAL"),e("menu_items","fat_g","REAL"),e("menu_items","carbs_g","REAL"),e("suppliers","lead_time_days","INTEGER"),e("suppliers","min_order_cents","INTEGER"),e("purchase_orders","freight_cents","INTEGER NOT NULL DEFAULT 0"),e("stock_batches","lot_code","TEXT"),e("purchase_order_items","prev_unit_cost_cents","INTEGER"),e("purchase_orders","unreceived_count","INTEGER NOT NULL DEFAULT 0"),e("purchase_orders","unreceived_at","TEXT"),e("purchase_orders","unreceived_by","INTEGER"),e("stock_batches","received_at","TEXT"),e("users","password_changed_at","TEXT"),e("users","must_change_password","INTEGER NOT NULL DEFAULT 0"),e("customers","last_stamp_at","TEXT"),e("payroll_lines","holiday_minutes","INTEGER NOT NULL DEFAULT 0"),e("payroll_lines","holiday_premium_cents","INTEGER NOT NULL DEFAULT 0");try{E.exec("SELECT name FROM sqlite_master WHERE type='table' AND name='order_payments'").length>0&&E.exec(`
    ...
    `)}catch{}((I=(o=E.exec("SELECT value FROM settings WHERE key = 'currency_symbol'")[0])==null?void 0:o.values[0])==null?void 0:I[0])==="$"&&E.exec("UPDATE settings SET value = '₱' WHERE key = 'currency_symbol'");const r=(((a=E.exec("SELECT id FROM users WHERE password_hash IS NULL OR password_hash = ''")[0])==null?void 0:a.values)??[]).map(n=>n[0]);if(r.length>0){const n=j("1234"),d=E.prepare("UPDATE users SET password_hash = ? WHERE id = ?");for(const R of r)d.run([n,R]);d.free()}E.exec(`
  ...
  `);try{V(E)}catch{}}function V(E){var o,I,a;const T=((I=(o=E.exec("SELECT sql FROM sqlite_master WHERE type='table' AND name='users'")[0])==null?void 0:o.values[0])==null?void 0:I[0])??"";if(!T||T.includes("'accountant'"))return;const t=T.replace(/CHECK\s*\(\s*role\s+IN\s*\([^)]*\)\s*\)/i,"CHECK (role IN ('owner', 'manager', 'cashier', 'kitchen', 'accountant') OR role LIKE 'r\\_%' ESCAPE '\\')");if(t===T)return;const s=t.replace(/^CREATE\s+TABLE\s+(IF\s+NOT\s+EXISTS\s+)?"?users"?/i,"CREATE TABLE users_rebuild_0171");if(s===t)return;const r=(((a=E.exec("PRAGMA table_info(users)")[0])==null?void 0:a.values)??[]).map(n=>`"${n[1]}"`).join(", ");if(r){E.exec("PRAGMA foreign_keys = OFF");try{E.exec("BEGIN"),E.exec(s),E.exec(`INSERT INTO users_rebuild_0171 (${r}) SELECT ${r} FROM users`),E.exec("DROP TABLE users"),E.exec("ALTER TABLE users_rebuild_0171 RENAME TO users"),E.exec("COMMIT")}catch(n){try{E.exec("ROLLBACK")}catch{}console.error("[ember] users role check rebuild skipped:",n)}finally{E.exec("PRAGMA foreign_keys = ON")}}}function j(E){const e=ne(16).toString("hex"),T=oe(E,e,1e5,32,"sha256").toString("hex");return`${e}:${T}`}function Oe(E){var u,U,h,m,G,f,D,w,M,b,v,k,P,Y,x,K;const e=E.prepare("INSERT OR IGNORE INTO settings (key, value) VALUES (?, ?)"),T=[["restaurant_name","My Restaurant"],["tax_percent","0"],["currency_symbol","₱"],["receipt_footer","Thank you — come again!"],["order_seq","0"],["biz_address",""],["biz_tin",""],["biz_vat_status","non-vat"],["biz_min",""],["biz_serial_no",""],["biz_accred_no",""],["biz_permit_no",""],["biz_receipt_prefix","OR-"],["or_seq","0"],["loyalty_stamps_required","10"],["idle_logout_minutes","0"],["daily_sales_goal_cents","0"],["kds_sound","1"],["kitchen_printer_name",""],["kitchen_auto_print","0"],["happy_hour_enabled","0"],["happy_hour_percent","10"],["happy_hour_start","14:00"],["happy_hour_end","17:00"],["drawer_network",""],["drawer_auto_kick","1"],["ui_zoom","1"],["receipt_logo",""],["setup_done","0"],["theme","dark"],["quote_seq","0"],["payroll_ot_threshold_hours","8"],["payroll_ot_multiplier","1.25"]];for(const[c,N]of T)e.run([c,N]);if(e.free(),((U=(u=E.exec("SELECT COUNT(*) as c FROM users")[0])==null?void 0:u.values[0])==null?void 0:U[0])===0){const c=j("1234"),N=E.prepare("INSERT INTO users (username, password_hash, full_name, role, pin, active) VALUES (?, ?, ?, ?, ?, 1)");N.run(["admin",c,"Owner","owner",null]),N.free()}const r=E.prepare("INSERT OR IGNORE INTO payment_types (name, code, sort_order, color, active) VALUES (?, ?, ?, ?, 1)");if(r.run(["Cash","cash",1,"#16a34a"]),r.run(["Card","card",2,"#2563eb"]),r.run(["GCash","gcash",3,"#0ea5e9"]),r.run(["Gift Card","giftcard",4,"#a855f7"]),r.free(),((m=(h=E.exec("SELECT COUNT(*) as c FROM predefined_tickets")[0])==null?void 0:h.values[0])==null?void 0:m[0])===0){const c=E.prepare("INSERT INTO predefined_tickets (label, kind, sort_order, active) VALUES (?, ?, ?, 1)");for(let N=1;N<=5;N++)c.run([`Table ${N}`,"table",N]);c.run(["Takeout","takeout",10]),c.free()}if(((f=(G=E.exec("SELECT COUNT(*) as c FROM dining_tables")[0])==null?void 0:G.values[0])==null?void 0:f[0])===0){const c=E.prepare("INSERT INTO dining_tables (label, seats, sort_order, active) VALUES (?, ?, ?, 1)");for(let N=1;N<=8;N++)c.run([String(N),N<=4?2:4,N]);c.free()}if(((w=(D=E.exec("SELECT COUNT(*) as c FROM expense_categories")[0])==null?void 0:D.values[0])==null?void 0:w[0])===0){const c=E.prepare("INSERT INTO expense_categories (name, kind, active, spread_basis, is_payroll) VALUES (?, ?, 1, ?, ?)");for(const N of se)c.run([N.name,N.kind,N.basis,B.includes(N.name.trim().toLowerCase())?1:0]);c.free()}if((b=(M=E.exec("SELECT value FROM settings WHERE key = 'fix_payroll_spread_done'")[0])==null?void 0:M.values)!=null&&b.length||(E.run(`UPDATE expense_categories SET spread_basis = 'open'
       WHERE spread_basis = 'calendar'
         AND lower(trim(name)) IN ('salaries & wages', 'salaries and wages', 'wages', 'payroll')`),E.run("INSERT OR REPLACE INTO settings (key, value) VALUES ('fix_payroll_spread_done', '1')")),!((k=(v=E.exec("SELECT value FROM settings WHERE key = 'flag_payroll_accounts_done'")[0])==null?void 0:v.values)!=null&&k.length)){const c=B.map(N=>`'${N.replace(/'/g,"''")}'`).join(", ");E.run(`UPDATE expense_categories SET is_payroll = 1
       WHERE is_payroll = 0 AND lower(trim(name)) IN (${c})`),E.run("INSERT OR REPLACE INTO settings (key, value) VALUES ('flag_payroll_accounts_done', '1')")}if(((Y=(P=E.exec("SELECT COUNT(*) as c FROM locations")[0])==null?void 0:P.values[0])==null?void 0:Y[0])===0){const c=E.prepare("INSERT INTO locations (name, sort_order, active) VALUES (?, ?, 1)");["Main Store","Kitchen","Bar Station","Cold Storage"].forEach((N,y)=>c.run([N,y+1])),c.free()}if(Z(E),((K=(x=E.exec("SELECT COUNT(*) as c FROM modifiers_library")[0])==null?void 0:x.values[0])==null?void 0:K[0])===0){const c=[["Extra rice","addons",1],["Extra egg","addons",2],["Extra sauce","addons",3],["Extra ice","temp",4],["No ice","temp",5],["Hot","temp",6],["Iced","temp",7],["No sugar","sugar",8],["Less sugar (50%)","sugar",9],["Sugar 25%","sugar",10],["Extra sweet","sugar",11],["No onions","omit",12],["No garlic","omit",13],["No spicy","spice",14],["Extra spicy","spice",15],["To go","service",16],["For pick-up","service",17],["Rush order","service",18]],N=E.prepare("INSERT INTO modifiers_library (text, category, sort_order, active) VALUES (?, ?, ?, 1)");for(const y of c)N.run(y);N.free()}}const $=[{capability:"pos.use",roles:["owner","manager","cashier"]},{capability:"kitchen.use",roles:["owner","manager","cashier","kitchen"]},{capability:"menu.read",roles:["owner","manager","cashier","kitchen"]},{capability:"menu.write",roles:["owner","manager"]},{capability:"inventory.read",roles:["owner","manager"]},{capability:"inventory.write",roles:["owner","manager"]},{capability:"inventory.adjust",roles:["owner","manager"]},{capability:"inventory.count",roles:["owner","manager"]},{capability:"reports.view",roles:["owner","manager","accountant"]},{capability:"admin.view",roles:["owner","manager"]},{capability:"admin.access",roles:["owner"]},{capability:"settings.read",roles:["owner","manager","cashier","kitchen","accountant"]},{capability:"settings.write",roles:["owner","manager"]},{capability:"users.manage",roles:["owner","manager"]},{capability:"orders.discount",roles:["owner","manager"]},{capability:"orders.void_paid",roles:["owner","manager"]},{capability:"csv.use",roles:["owner","manager","accountant"]},{capability:"backup.use",roles:["owner"]},{capability:"timeclock.use",roles:["owner","manager","cashier","kitchen"]},{capability:"timecards.view",roles:["owner","manager"]},{capability:"orders.refund",roles:["owner","manager"]},{capability:"shifts.manage",roles:["owner","manager","cashier"]},{capability:"shifts.cash",roles:["owner","manager"]},{capability:"payroll.run",roles:["owner","manager"]},{capability:"inventory.transfer",roles:["owner","manager"]},{capability:"branches.switch",roles:["owner","manager"]},{capability:"inventory.template_manage",roles:["owner","manager"]},{capability:"inventory.count_adjust",roles:["owner","manager"]},{capability:"shifts.see_expected",roles:["owner","manager"]},{capability:"inventory.receive",roles:["owner","manager","cashier","kitchen"]},{capability:"menu.availability",roles:["owner","manager","cashier","kitchen"]},{capability:"inventory.count_start",roles:["owner","manager"]}],J=["owner","manager","cashier","kitchen","accountant"];function Z(E){const e=E.prepare("INSERT OR IGNORE INTO role_permissions (role, capability, allowed) VALUES (?, ?, ?)");for(const{capability:T,roles:t}of $)for(const s of J)e.run([s,T,t.includes(s)?1:0]);e.free()}function ee(E,e){const T=e.findIndex(t=>t===void 0);if(T!==-1)throw new Error(`SQL bind #${T+1} is undefined in: ${E.replace(/\s+/g," ").slice(0,160)}`)}function Ee(E,e=[]){ee(E,e);const T=p().prepare(E);e.length&&T.bind(e);const t=[];for(;T.step();)t.push(T.getAsObject());return T.free(),t}function pe(E,e=[]){return Ee(E,e)[0]??null}function he(E,e=[]){var r;ee(E,e);const T=p();T.run(E,e);const s=((r=T.exec("SELECT last_insert_rowid() as id, changes() as ch")[0])==null?void 0:r.values[0])??[0,0];return X(),{lastInsertRowid:s[0],changes:s[1]}}function me(E){p().exec(E),X()}function Se(E){const e=p();e.exec("BEGIN");try{const T=E();return e.exec("COMMIT"),C(),T}catch(T){throw e.exec("ROLLBACK"),T}}function C(){l&&(globalThis.__EMBER_DEFER_SAVES__||ue(F,l.export()))}function X(E=500){g&&clearTimeout(g),g=setTimeout(C,E)}const Ge=Object.freeze(Object.defineProperty({__proto__:null,ALL_ROLES:J,CAPABILITY_DEFAULTS:$,all:Ee,exec:me,getDb:p,getDbFilePath:le,initDatabase:Ue,one:pe,run:he,saveDebounced:X,saveNow:C,seedDefaultPermissions:Z,transaction:Se,widenUsersRoleCheck:V},Symbol.toStringTag,{value:"Module"}));export{Ee as a,he as b,Xe as c,Ge as d,Se as e,le as g,pe as o,oe as p,ne as r,C as s,Fe as t};
