var $=Object.defineProperty;var J=(E,e,T)=>e in E?$(E,e,{enumerable:!0,configurable:!0,writable:!0,value:T}):E[e]=T;var A=(E,e,T)=>J(E,typeof e!="symbol"?e+"":e,T);import{S as Z}from"./expense-accounts-D6RZdT5F.js";import{i as ee}from"./sql-wasm-browser-mwzwnb94.js";class K extends Uint8Array{toString(e){if(e==="hex"||e===void 0){let T="";for(let t=0;t<this.length;t++)T+=this[t].toString(16).padStart(2,"0");return T}if(e==="utf8"||e==="utf-8")return new TextDecoder().decode(this);throw new Error("HexBytes.toString: unsupported encoding "+e)}}function Ee(E){const e=new K(E);return crypto.getRandomValues(e),e}function me(E,e){if(E.length!==e.length)throw new Error("Input buffers must have the same length");let T=0;for(let t=0;t<E.length;t++)T|=E[t]^e[t];return T===0}const te=new Uint32Array([1116352408,1899447441,3049323471,3921009573,961987163,1508970993,2453635748,2870763221,3624381080,310598401,607225278,1426881987,1925078388,2162078206,2614888103,3248222580,3835390401,4022224774,264347078,604807628,770255983,1249150122,1555081692,1996064986,2554220882,2821834349,2952996808,3210313671,3336571891,3584528711,113926993,338241895,666307205,773529912,1294757372,1396182291,1695183700,1986661051,2177026350,2456956037,2730485921,2820302411,3259730800,3345764771,3516065817,3600352804,4094571909,275423344,430227734,506948616,659060556,883997877,958139571,1322822218,1537002063,1747873779,1955562222,2024104815,2227730452,2361852424,2428436474,2756734187,3204031479,3329325298]);class S{constructor(){A(this,"h",new Uint32Array([1779033703,3144134277,1013904242,2773480762,1359893119,2600822924,528734635,1541459225]));A(this,"block",new Uint8Array(64));A(this,"w",new Uint32Array(64));A(this,"fill",0);A(this,"len",0)}update(e){this.len+=e.length;let T=0;for(;T<e.length;){const t=Math.min(64-this.fill,e.length-T);this.block.set(e.subarray(T,T+t),this.fill),this.fill+=t,T+=t,this.fill===64&&(this.compress(),this.fill=0)}return this}compress(){const{block:e,w:T,h:t}=this;for(let n=0;n<16;n++)T[n]=e[n*4]<<24|e[n*4+1]<<16|e[n*4+2]<<8|e[n*4+3];for(let n=16;n<64;n++){const _=T[n-15],a=T[n-2],u=(_>>>7|_<<25)^(_>>>18|_<<14)^_>>>3,l=(a>>>17|a<<15)^(a>>>19|a<<13)^a>>>10;T[n]=T[n-16]+u+T[n-7]+l|0}let s=t[0],r=t[1],o=t[2],I=t[3],L=t[4],i=t[5],d=t[6],R=t[7];for(let n=0;n<64;n++){const _=(L>>>6|L<<26)^(L>>>11|L<<21)^(L>>>25|L<<7),a=L&i^~L&d,u=R+_+a+te[n]+T[n]|0,l=(s>>>2|s<<30)^(s>>>13|s<<19)^(s>>>22|s<<10),h=s&r^s&o^r&o,m=l+h|0;R=d,d=i,i=L,L=I+u|0,I=o,o=r,r=s,s=u+m|0}t[0]=t[0]+s|0,t[1]=t[1]+r|0,t[2]=t[2]+o|0,t[3]=t[3]+I|0,t[4]=t[4]+L|0,t[5]=t[5]+i|0,t[6]=t[6]+d|0,t[7]=t[7]+R|0}digest(){const e=this.len*8;for(this.update(new Uint8Array([128]));this.fill!==56;)this.update(new Uint8Array([0]));const T=new Uint8Array(8);T[0]=e/4294967296>>>24,T[1]=e/4294967296>>>16,T[2]=e/4294967296>>>8,T[3]=e/4294967296&255,T[4]=e>>>24&255,T[5]=e>>>16&255,T[6]=e>>>8&255,T[7]=e&255,this.update(T);const t=new Uint8Array(32);for(let s=0;s<8;s++)t[s*4]=this.h[s]>>>24,t[s*4+1]=this.h[s]>>>16&255,t[s*4+2]=this.h[s]>>>8&255,t[s*4+3]=this.h[s]&255;return t}}const Te=E=>new S().update(E).digest();function x(E,e){let T=E.length>64?Te(E):E;const t=new Uint8Array(64).fill(54),s=new Uint8Array(64).fill(92);for(let o=0;o<T.length;o++)t[o]^=T[o],s[o]^=T[o];const r=new S().update(t).update(e).digest();return new S().update(s).update(r).digest()}function se(E,e,T,t,s){if(s!=="sha256")throw new Error("pbkdf2Sync shim: only sha256");const r=typeof E=="string"?new TextEncoder().encode(E):E,o=typeof e=="string"?new TextEncoder().encode(e):e,I=new K(t),L=Math.ceil(t/32);for(let i=1;i<=L;i++){const d=new Uint8Array(o.length+4);d.set(o),d[o.length]=i>>>24,d[o.length+1]=i>>>16&255,d[o.length+2]=i>>>8&255,d[o.length+3]=i&255;let R=x(r,d);const n=new Uint8Array(R);for(let _=1;_<T;_++){R=x(r,R);for(let a=0;a<32;a++)n[a]^=R[a]}I.set(n.subarray(0,Math.min(32,t-(i-1)*32)),(i-1)*32)}return I}function Se(E){if(E!=="sha256")throw new Error("createHash shim: only sha256");const e=new S,T={update(t){return e.update(typeof t=="string"?new TextEncoder().encode(t):t),T},digest(t){const s=e.digest();if(t==="hex")return Array.from(s).map(r=>r.toString(16).padStart(2,"0")).join("");if(t)throw new Error("createHash shim: only hex");return s}};return T}const re="/demo/assets/sql-wasm-UFUCzYNW.wasm",ne="emberpos-demo",O="db",B="bytes";function q(){return new Promise((E,e)=>{const T=indexedDB.open(ne,1);T.onupgradeneeded=()=>T.result.createObjectStore(O),T.onsuccess=()=>E(T.result),T.onerror=()=>e(T.error)})}async function ie(){try{const E=await q();return await new Promise(e=>{const t=E.transaction(O,"readonly").objectStore(O).get(B);t.onsuccess=()=>e(t.result instanceof Uint8Array?t.result:null),t.onerror=()=>e(null)})}catch{return null}}async function Ne(E){try{const e=await q();await new Promise(T=>{const t=e.transaction(O,"readwrite");t.objectStore(O).put(E,B),t.oncomplete=()=>T(),t.onerror=()=>T()})}catch{}}function oe(){return"browser:indexeddb/emberpos-demo"}async function ae(){return ee({locateFile:()=>re})}async function de(E){const e=await ie();if(e&&e.length>0)return e;const T=t=>{const s="SQLite format 3";for(let r=0;r<s.length;r++)if(t[r]!==s.charCodeAt(r))return null;return t};if(typeof DecompressionStream=="function")try{const t=await fetch("demo-shop.db.gz",{cache:"no-store"});if(t.ok&&t.body){const s=t.body.pipeThrough(new DecompressionStream("gzip")),r=T(new Uint8Array(await new Response(s).arrayBuffer()));if(r)return r}}catch{}try{const t=await fetch("demo-shop.db",{cache:"no-store"});return t.ok?T(new Uint8Array(await t.arrayBuffer())):null}catch{return null}}let Y=Promise.resolve();function ce(E,e){const T=new Uint8Array(e);Y=Y.then(()=>Ne(T))}let U=null,F="",g=null;function p(){if(!U)throw new Error("Database not initialized. Call initDatabase() first.");return U}function Le(){return F}async function Re(){F=oe();const E=await ae(),e=await de();return U=e?new E.Database(e):new E.Database,U.exec(`
